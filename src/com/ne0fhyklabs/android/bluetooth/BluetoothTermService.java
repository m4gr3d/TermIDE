 ...
 */
public class BluetoothTermService {
    // Debugging
    private static final String TAG = BluetoothTermService.class.getName();
     ...
     */
    public BluetoothTermService(Context context, Handler handler) {
    ...
    private void connectionFailed() {
        ...
        BluetoothTermService.this.start();
    }
    ...
    private class AcceptThread extends Thread {
        ...
        public void run() {
            ...
            while (mState != STATE_CONNECTED) {
                ...
                if (socket != null) {
                    synchronized (BluetoothTermService.this) {
                        switch (mState) {
                        case STATE_LISTEN:
