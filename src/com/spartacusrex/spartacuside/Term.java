...
import com.ne0fhyklabs.android.bluetooth.BluetoothTerm;
import com.ne0fhyklabs.android.bluetooth.BluetoothTermService;
...
public class Term extends Activity {
    ...
    private BluetoothTerm mBtTerm;
    private BluetoothTermService mBtTermService;
    ...
    private final Handler mBtHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                default:
                    // Send the remaining messages to the bluetooth terminal.
                    Handler btTermHandler = mBtTerm != null ? mBtTerm.getHandler() : null;
                    if ( btTermHandler != null )
                        btTermHandler.handleMessage(msg);
                    break;
            }
        }
    };
    ...
    public void onCreate(Bundle icicle) {
        ...
        // Initialize the bluetooth terminal, and service.
        // TODO: initialize the bluetooth terminal service.
    ...
    protected void setupBtTermService() {
        mBtTermService = new BluetoothTermService(this, mBtHandler);
    }
    ...
    public BluetoothTermService getBluetoothTermService() {
        return mBtTermService;
    }
    ...
    public void onDestroy() {
        ...
        // shutdown the bluetooth terminal service.
        if ( mBtTermService != null )
            mBtTermService.stop();
    }
    ...
    public void onResume() {
        ...
        if ( mBtTermService != null ) {
            ...
            if ( mBtTermService.getState() == BluetoothTermService.STATE_NONE ) {
                // Start the Bluetooth chat services
                mBtTermService.start();
            }
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.menu_back_esc:
                doBACKtoESC();
                break;

            case R.id.menu_keylogger:
                doToggelKeyLogger();
                break;
            ...
            case R.id.menu_copyall:
                doCopyAll();
                break;

            case R.id.menu_copyemail:
                doEmailTranscript();
                break;

            case R.id.menu_toggle_bt_term:
                if ( mBluetoothAdapter == null ) {
                    Toast.makeText(this, "Bluetooth is not available", Toast.LENGTH_LONG).show();
                }
                else {
                    View btTermView = findViewById(R.id.bt_term);

                    if ( btTermView.getVisibility() == View.VISIBLE ) {
                        btTermView.setVisibility(View.GONE);
                        mViewFlipper.setVisibility(View.VISIBLE);
                    }
                    else {
                        btTermView.setVisibility(View.VISIBLE);
                        mViewFlipper.setVisibility(View.GONE);

                        if ( mBtTerm == null ) {
                            FragmentManager fm = getFragmentManager();
                            mBtTerm = (BluetoothTerm) fm.findFragmentById(R.id.bt_term);
                            if ( mBtTerm == null ) {
                                mBtTerm = new BluetoothTerm();
                                fm.beginTransaction().add(R.id.bt_term, mBtTerm).commit();
                            }
                        }
                    }
                }
